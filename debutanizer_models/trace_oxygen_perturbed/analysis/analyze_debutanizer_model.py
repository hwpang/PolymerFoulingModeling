...
ax = fig.add_subplot(gs[0, 0])
alpha1_RC_add = alpha1 * consumption_rates["RC._add"] / (consumption_rates["RC._add"] + consumption_rates["RC.+O2"])
alpha1_RC_O2 = alpha1 * consumption_rates["RC.+O2"] / (consumption_rates["RC._add"] + consumption_rates["RC.+O2"])
