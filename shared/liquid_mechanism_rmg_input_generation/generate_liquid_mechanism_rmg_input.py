...
# Data sources
database(
    thermoLibraries = ['hwpang_fouling','Conjugated_diene','thermo_DFT_CCSDTF12_BAC','primaryThermoLibrary', 'primaryNS', 'NitrogenCurran', 'NOx2018', 'FFCM1(-)', 'SulfurLibrary', 'SulfurGlarborgH2S'],
    reactionLibraries = ['hwpang_fouling','Xu_cyclopentadiene','Conjugated_diene','Klippenstein_Glarborg2016'],
    seedMechanisms = [],
