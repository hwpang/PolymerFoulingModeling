...
liquid_molfraction = pd.read_excel(
    aspen_results_path, engine="openpyxl", sheet_name="LiquidCompositionMoleBasis"
)

# Read vapor molar fraction data
vapor_molfraction = pd.read_excel(
    aspen_results_path, engine="openpyxl", sheet_name="VaporCompositionMoleBasis"
)

# Read stream data
stream = pd.read_excel(
    aspen_results_path, engine="openpyxl", sheet_name="StreamResults"
)
...
initial_conditions[
    "liquid_outlet_volumetric_flowrate"
] = liquid_outlet_volumetric_flowrate.tolist()
...
initial_conditions[
    "vapor_outlet_volumetric_flowrate"
] = vapor_outlet_volumetric_flowrate.tolist()
