...
ax = axes[0, 0]
ax.violinplot(list(H298_diff_by_carbon_num.values()), positions=list(H298_diff_by_carbon_num.keys()), showmeans=True)
...
ax = axes[1, 0]
ax.violinplot(list(S298_diff_by_carbon_num.values()), positions=list(S298_diff_by_carbon_num.keys()), showmeans=True)
ax.plot([min_carbon_num-0.5, max_carbon_num+0.5], [0, 0], '--', color='gray')
ax.set_xticks(range(min_carbon_num, max_carbon_num+1))
ax.set_xticklabels(range(min_carbon_num, max_carbon_num+1))
...
ax = axes[0, 1]
ax.violinplot(list(H298_diff_by_oxygen_num.values()), positions=list(H298_diff_by_oxygen_num.keys()), showmeans=True)
...
ax = axes[1, 1]
ax.violinplot(list(S298_diff_by_oxygen_num.values()), positions=list(S298_diff_by_oxygen_num.keys()), showmeans=True)
ax.plot([min_oxygen_num-0.5, max_oxygen_num+0.5], [0, 0], '--', color='gray')
ax.set_xticks(range(min_oxygen_num, max_oxygen_num+1))
ax.set_xticklabels(range(min_oxygen_num, max_oxygen_num+1))
